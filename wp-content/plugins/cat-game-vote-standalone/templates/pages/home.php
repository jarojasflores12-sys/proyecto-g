...
<section class="cg-home-section">
    <article class="cg-card cg-home-guide" aria-labelledby="cg-home-guide-title">
        ...
        <section id="cg-community-rules" class="cg-home-rules-modal" aria-labelledby="cg-community-rules-title">
            <article class="cg-home-rules-modal__card cg-card">
                ...
                <a class="cg-btn cg-btn--ghost" href="#">Cerrar</a>
            </article>
        </section>
    </article>
</section>
